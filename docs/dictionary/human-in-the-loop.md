...
Staying in the loop costs your attention, which is the scarce resource. Part of getting better with agents is moving more work safely out of the loop — with plans, [automated checks](./automated-check.md), and [human review](./human-review.md) at the end instead of supervision throughout.
