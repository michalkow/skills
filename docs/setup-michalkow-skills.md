...
You invoke this by typing `/setup-michalkow-skills` — the [agent](https://michalkow.github.io/dictionary-of-ai-coding/agent) won't reach for it on its own. It is deliberately marked non-invokable, so no other skill can fire it for you.
...
**Can I configure the other skills' behaviour here — [grilling](https://michalkow.github.io/dictionary-of-ai-coding/grilling) cadence, question format, tone?**
