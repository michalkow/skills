...
**I pointed a session at it and it burned 100k [tokens](https://michalkow.github.io/skills/dictionary/token) redesigning things I never asked about.**
...
Not cleanly. `DESIGN-IT-TWICE.md` says "spawn 3+ sub-agents in parallel using the Agent tool", which is Claude Code's [tool](https://michalkow.github.io/skills/dictionary/tool) by Claude Code's name. The repo ships metadata for other [harnesses](https://michalkow.github.io/skills/dictionary/harness), including Codex, and those may expose nothing under that name — so the parallel-design phase is less portable than the skill's metadata suggests. Tracked in [issue #564](https://github.com/mattpocock/skills/issues/564), open.

**Can I add my own concepts to the glossary — connascence, module secrets, [progressive disclosure](https://michalkow.github.io/skills/dictionary/progressive-disclosure)?**
