...
| The *words of the domain* — "account" means three things, two people mean different things by "cancellation" | [domain-modeling](https://michalkow.github.io/skills/domain-modeling) |
| You don't yet know *which* module to redesign | [improve-codebase-architecture](https://michalkow.github.io/skills/improve-codebase-architecture) — the survey that finds candidates |
| You want the design argued with, not just named | [grilling](https://michalkow.github.io/skills/grilling) |
| There's a concrete behaviour to build and you want tests that survive a refactor | [tdd](https://michalkow.github.io/skills/tdd) |
...
**I pointed a session at it and it burned 100k [tokens](https://michalkow.github.io/dictionary-of-ai-coding/token) redesigning things I never asked about.**
...
Not cleanly. `DESIGN-IT-TWICE.md` says "spawn 3+ sub-agents in parallel using the Agent tool", which is Claude Code's [tool](https://michalkow.github.io/dictionary-of-ai-coding/tool) by Claude Code's name. The repo ships metadata for other [harnesses](https://michalkow.github.io/dictionary-of-ai-coding/harness), including Codex, and those may expose nothing under that name — so the parallel-design phase is less portable than the skill's metadata suggests. Tracked in [issue #564](https://github.com/mattpocock/skills/issues/564), open.

**Can I add my own concepts to the glossary — connascence, module secrets, [progressive disclosure](https://michalkow.github.io/dictionary-of-ai-coding/progressive-disclosure)?**
