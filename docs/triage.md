...
You invoke this by typing `/triage` and then describing what you want in plain language — the [agent](https://michalkow.github.io/skills/dictionary/agent) won't reach for it on its own. "Show me anything that needs my attention", "let's look at #42", "move #42 to ready-for-agent".
...
| A settled conversation to turn into a [spec](https://michalkow.github.io/skills/dictionary/spec) | [to-spec](https://michalkow.github.io/skills/to-spec) |
...
| `ready-for-agent` | Fully specified, with an agent brief attached. An [AFK](https://michalkow.github.io/skills/dictionary/afk) agent can take it. |
