...
`to-spec` turns the conversation you have just had into a **[spec](https://michalkow.github.io/dictionary-of-ai-coding/spec)**, and publishes it to your issue tracker as a single issue.
...
You invoke this by typing `/to-spec` — the [agent](https://michalkow.github.io/dictionary-of-ai-coding/agent) won't reach for it on its own.

Reach for it when the build is too big for one agent [session](https://michalkow.github.io/dictionary-of-ai-coding/session) and has to survive being split across several. That is the whole trigger:

| Where you are | What to run |
| --- | --- |
| You haven't decided anything yet | [grill-with-docs](https://michalkow.github.io/skills/grill-with-docs) first |
| Decided, and the work fits one [context window](https://michalkow.github.io/dictionary-of-ai-coding/context-window) | [implement](https://michalkow.github.io/skills/implement) — skip the spec |
...
The spec exists because context windows end. Everything you settled while [grilling](https://michalkow.github.io/dictionary-of-ai-coding/grilling) — the shape of the solution, the choices you argued through, what you deliberately refused — is in one conversation that is about to be cleared. The spec is what survives that.
