...
- **The map.** Point to [ask-michal](https://aihero.dev/skills-ask-michal), the router over the whole set, so this page stays a node and never has to redraw the graph.
