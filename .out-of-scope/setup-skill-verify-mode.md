# Verify/Check Mode for `setup-michalkow-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-michalkow-skills`.
...
- #106 — Feature request: verify/check mode for setup-michalkow-skills
